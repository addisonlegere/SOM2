...
$header_img_1 = get_stylesheet_directory_uri() . "/images/emails/header_1.jpg";
                                	 ...
                                	 <table border="0" cellpadding="0" cellspacing="0" width="600" id="template_header" style="<?php echo $template_header; ?>" bgcolor="<?php echo $base; ?>">
                                        <tr>
                                            <td style="height: 145px;">
                                                <a href="http://www.bennyhinnbiblestudy.org/donate-now/"><img style="display: block;" src="<?php echo esc_url($header_img_1); ?>" alt="<?php echo get_bloginfo('name'); ?>" /></a>
                                            </td>
